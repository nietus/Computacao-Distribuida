...
# ============================================================================
# Note: HTTP RPC endpoints have been removed.
# Inter-node communication now exclusively uses gRPC.
# See: app/distributed/grpc_server.py for gRPC service implementation.
